...
//The Joe Shmoe student Object from constructor
// 2. What is "this" when joe.scopeArrow() is invoked?
//Since arrow is part of it, 'this' is referring to the global object.
// 3. Explain why "this" is different when an arrow function is used.
//Now that arrow functions are scoped globally, this will refer to the global object, whereas this in the constructor will refer to the local.